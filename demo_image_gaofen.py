...
class DetectorModel():
    ...
    def crop_single(self, srcpath, dstpath, slide_size, chip_size):
        # 有几个目标，有几个ndarry，前8个是坐标，最有一个是置信度
        detections = self.inference_single(srcpath, slide_size, chip_size)
        detection = detections[0]
        for det in detection:
            x1, y1, x2, y2, x3, y3, x4, y4 = [c for c in det[:8]]
...
if __name__ == '__main__':
    model = DetectorModel(
        r"configs/ReDet/ReDet_re50_refpn_1x_gaofen_project.py",
        r"work_dirs/ReDet_re50_refpn_1x_gaofen_project/epoch_12.pth")

    img_dir = "/home/penguin/可视化"
    out_dir = '/home/penguin/可视化result'

    # annopath = r'/home/penguin/Experiments/ReDet/data/gaofen-det/test/label_txt/{:s}.txt'  # change the directory to the path of val/labelTxt, if you want to do evaluation on the valset
    # imagesetfile = r'/home/penguin/Experiments/ReDet/data/gaofen-det/test/testset.txt'
    ...
    for img_name in img_names:
        ...
        model.inference_single_vis(img_path, out_path, (800, 800), (1000, 1000))
