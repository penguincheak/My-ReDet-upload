...
def parse_args():
    ...
    parser.add_argument('config',
                        default='/home/penguin/Experiments/ReDet/configs/ReDet/ReDet_re50_refpn_3x_hrsc2016.py',
                        help='test config file path')
    parser.add_argument('checkpoint',
                        default='/home/penguin/Experiments/ReDet/work_dirs/ReDet_re50_refpn_3x_hrsc2016/epoch_36_multiscale.pth',
