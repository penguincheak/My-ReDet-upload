...
if __name__ == '__main__':
    model = DetectorModel(
        r"configs/ReDet/ReDet_re50_refpn_1x_dota15.py",
        r"work_dirs/ReDet_re50_refpn_1x_dota15/epoch_11.pth")
    ...
    for img_name in img_names:
        ...
        model.inference_single_vis(img_path, out_path, (217, 228), (217, 228))
