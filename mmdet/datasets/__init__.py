...
from .GaoFen_challenge import GaoFen_challengeDataset
from .GaoFen_detect import GaoFen_detDataset
from .GaoFen_Coarse import GaoFenCoarseDataset
from .NWPU_VHR_10 import NWPU_VHR_10
...
__all__ = [
    ...
    'DIORDataset', 'GaoFenDataset', 'GaoFen_challengeDataset', 'GaoFen_detDataset',
    'GaoFenCoarseDataset', 'NWPU_VHR_10'
]
