...
from mmdet.core import merge_rotate_aug_bboxes, merge_rotate_aug_proposals, merge_rotate_aug_proposals1
...
class RPNTestMixin(object):
    ...
    def aug_test_rpn_rotate(self, feats, img_metas, rpn_test_cfg):
        ...
        #     for proposals, img_meta in zip(aug_proposals, img_metas)
        # ]
        merged_proposals = merge_rotate_aug_proposals1(aug_proposals, img_metas, rpn_test_cfg)
        return merged_proposals
