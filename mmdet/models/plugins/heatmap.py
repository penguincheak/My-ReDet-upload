...
class Heatmap:
    def __init__(self, fpn_lvl=4,
        ...
        # dior mmax:479814.0 mmin:0.0
        # DOTA 3 22
        # DOTA1效果好 9 12
        # hrsc2016 10 15
        self.min_size = 9  # 2 & 5 is related to anchor size (anchor-based method) or object size (anchor-free method)
        self.max_size = 12
        self.neg_weight = 3
    ...
    def reg_mask(self, pred_att, gt_att):
        ...
        if pos_num == 0:
            ...
            # if bg_num > len(bg_score_sorted):
            #     if len(bg_score_sorted) == 0:
            #         threshold = 0.0
            #     else:
            #         threshold = -bg_score_sorted[-1]
            # else:
        ...
        # if bg_num == 0:
        #     threshold = 0.0
        # elif bg_num > len(bg_score_sorted):
        #     threshold = -bg_score_sorted[-1]
        # else:
        #     threshold = -bg_score_sorted[bg_num - 1]
        # 原始
    ...
    def target(self, pred_att, anns):
        ...
        # batch size, channel_num, height, width
