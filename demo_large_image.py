...
class DetectorModel():
    ...
    def inference_single(self, imagname, slide_size, chip_size):
        ...
        for i in range(len(self.classnames)):
            keep = py_cpu_nms_poly_fast_np(total_detections[i], 0.05)
...
#     model = DetectorModel(
#         r"configs/ReDet/ReDet_re50_refpn_1x_dota1.py",
#         r"work_dirs/ReDet_re50_refpn_1x_dota1/epoch_12.pth")
#
#     img_dir = "/home/penguin/test_img"
#     out_dir = '/home/penguin/test_ori'
#     img_names = os.listdir(img_dir)
#     for img_name in img_names:
#         print(img_name)
#         img_path = os.path.join(img_dir, img_name)
#         out_path = os.path.join(out_dir, img_name)
#         model.inference_single_vis(img_path, out_path, (824, 824), (1024, 1024))

if __name__ == '__main__':
    model = DetectorModel(
        r"configs/ReDet-SSP/ReDet_re50_ressp_3x_dior.py",
        r"work_dirs/ReDet_re50_ressp_3x_dior/epoch_12.pth")
        # r"work_dirs/ReDet_re50_refpn_3x_hrsc2016/epoch_36.pth")
    ...
    for img_name in img_names:
        ...
        img_path = os.path.join(img_dir, img_name)
        out_path = os.path.join(out_dir, img_name)
        model.inference_single_vis(img_path, out_path, (800, 800), (800, 800))
