...
def main():
    detpath = r'/home/penguin/Experiments/ReDet/work_dirs/ReDet_re50_refpn_1x_gaofen_project/Task1_results_nms/Task1_{:s}.txt'
    annopath = r'/home/penguin/EDisk/gaofen_project/test/labelTxt/{:s}.txt'  # change the directory to the path of val/labelTxt, if you want to do evaluation on the valset
    imagesetfile = r'/home/penguin/EDisk/gaofen_project/test/testset.txt'
