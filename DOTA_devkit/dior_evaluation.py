...
def main():
    detpath = r'/home/penguin/Experiments/ReDet/work_dirs/ReDet_re50_refpn_3x_dior/Task1_results_nms/Task2_{:s}.txt'
    annopath = r'/home/penguin/Experiments/ReDet/data/dior/test/labelTxt/{:s}.txt'  # change the directory to the path of val/labelTxt, if you want to do evaluation on the valset
    imagesetfile = r'/home/penguin/Experiments/ReDet/data/dior/test/test.txt'

    aps = []
    for iou_thr in [0.2]:#, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95]:
        # 保存每个类别的ap值
        ap_dict = {}
