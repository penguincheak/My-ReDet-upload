...
def parse_args():
    ...
    parser.add_argument('--srcpath', default='/home/penguin/DataSet/dota')
    parser.add_argument('--dstpath', default=r'/home/penguin/EDisk/data/dota1-split-1024',
                        help='prepare data')
    # parser.add_argument('--srcpath', default='/home/penguin/EDisk/data/dota_test/')
    # parser.add_argument('--dstpath', default=r'/home/penguin/EDisk/data/dota_test/dota1-split-1024',
    #                     help='prepare data')
