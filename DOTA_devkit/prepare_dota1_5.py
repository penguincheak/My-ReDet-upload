...
def parse_args():
    ...
    parser.add_argument('--srcpath', default='/home/penguin/dota')
    parser.add_argument('--dstpath', default=r'/home/penguin/EDisk/data/dota1_5-test',
                        help='prepare data')
...
def prepare(srcpath, dstpath):
    ...
    DOTA2COCOTrain(os.path.join(dstpath, 'train1024'), os.path.join(dstpath, 'train1024', 'DOTA1_5_train1024.json'), wordname_16, difficult='-1')
    DOTA2COCOTrain(os.path.join(dstpath, 'val1024'), os.path.join(dstpath, 'val1024', 'DOTA1_5_val1024.json'), wordname_16, difficult='-1')
