...
L1_names = ['airplane', 'airport', 'baseballfield', 'basketballcourt', 'bridge', 'chimney', 'dam', 'Expressway-Service-area', 'Expressway-toll-station', 'harbor', 'golffield', 'groundtrackfield', 'overpass', 'ship', 'stadium', 'storagetank', 'tenniscourt', 'trainstation', 'vehicle', 'windmill']
# TODO: finish them
L2_names = []
L3_names = []
...
if __name__ == '__main__':
    DIOR2COCOTrain(r'data/dior/trainval',
                   r'data/dior/trainval/DIOR_L1_train.json',
                   L1_names)
    DIOR2COCOTest(r'data/dior/test',
