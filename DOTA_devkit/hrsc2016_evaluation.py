...
def main():
    ...
    detpath = r'work_dirs/ReDet_re50_refpn_3x_hrsc2016/Task1_results_nms/Task1_ship.txt'
    # detpath = r'work_dirs/ReDet_re50_exp_hrsc2016/Task1_results/Task1_ship.txt'
    ...
    aps = []
    for iou_thr in [0.2, 0.3, 0.4, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95]:
...
# AP50: 90.56	AP75: 89.54	 mAP: 71.55
# AP50: 90.58	AP75: 89.60	 mAP: 71.29